...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  {
    slug: 'adiposity-rebound',
    term: 'Adiposity Rebound',
    letter: 'A',
    category: 'Child Health',
    siteCategory: 'Health',
    shortDef: 'Adiposity rebound is the natural rise in BMI that occurs in early childhood after an initial dip. BMI falls from infancy to a minimum (the adiposity nadir) typically between ages 4 and 6, then rises again. Children whose rebound begins before age 5 have a substantially higher risk of adult obesity, even when their current BMI percentile appears normal.',
    relatedTools: ['/health/bmi-calculator/kids', '/health/bmi-calculator/teens'],
    relatedTerms: ['adiposity-nadir', 'bmi-percentile', 'bmi'],
  },
  {
    slug: 'adiposity-nadir',
    term: 'Adiposity Nadir',
    letter: 'A',
    category: 'Child Health',
    siteCategory: 'Health',
    shortDef: 'The adiposity nadir is the lowest point in a child\'s BMI trajectory, typically occurring between ages 4 and 6. After this minimum, BMI rises again in the phase known as adiposity rebound. The age at which the nadir occurs is a stronger predictor of adult obesity risk than the BMI value at that age.',
    relatedTools: ['/health/bmi-calculator/kids'],
    relatedTerms: ['adiposity-rebound', 'bmi-percentile', 'bmi'],
  },
  {
  ...
  },
  {
    ...
    siteCategory: 'Health',
    shortDef: 'Obstetrics is the branch of medicine that covers pregnancy, labor, childbirth, and the postpartum period. An obstetrician (OB) manages prenatal care, monitors fetal development, delivers babies, and treats pregnancy complications. It is commonly practiced alongside gynecology as OB/GYN.',
    relatedTools: ['/health/pregnancy-calculator', '/health/bmi-calculator/pregnancy'],
    relatedTerms: ['gestational-age', 'fetal-age', 'naegeles-rule'],
  },
  {
    slug: 'fetal-age',
    term: 'Fetal Age',
    ...
    category: 'Maternal Health',
    siteCategory: 'Health',
    shortDef: 'Fetal age (also called embryonic age or fertilization age) is the age of an embryo or fetus counted from the date of fertilization, roughly two weeks less than gestational age. A baby delivered at term is approximately 38 weeks fetal age, though doctors universally record 40 weeks gestational age.',
    relatedTools: ['/health/pregnancy-calculator'],
    relatedTerms: ['gestational-age', 'naegeles-rule'],
  },
  {
    ...
    category: 'Maternal Health',
    siteCategory: 'Health',
    shortDef: 'Gestational age is the age of a pregnancy measured in weeks and days from the first day of the last menstrual period (LMP). A full-term pregnancy is 40 weeks of gestational age. It differs from fetal age (counted from conception) by approximately two weeks.',
    relatedTools: ['/health/pregnancy-calculator', '/health/bmi-calculator/pregnancy'],
    relatedTerms: ['fetal-age', 'gestational-weight-gain', 'naegeles-rule'],
  },
  {
  ...
  },
  {
    ...
    category: 'Maternal Health',
    siteCategory: 'Health',
    shortDef: "Naegele's rule is the standard formula for estimating a pregnancy due date: add 280 days (40 weeks) to the first day of the last menstrual period. It was established by German obstetrician Franz Karl Naegele in 1812 and remains the universal clinical standard today.",
    relatedTools: ['/health/pregnancy-calculator', '/health/bmi-calculator/pregnancy'],
    relatedTerms: ['fetal-age', 'gestational-age', 'gestational-weight-gain'],
  },
  {
    slug: 'net-pay',
    term: 'Net Pay',
  ...
  },
  {
    ...
    relatedTools: ['/health/bmi-calculator/men', '/health/bmi-calculator/women', '/health/body-fat-calculator', '/health/lean-body-mass-calculator', '/health/bmi-calculator/menopause', '/health/bmi-calculator/pregnancy', '/health/bmi-calculator/kids', '/health/bmi-calculator/seniors'],
  ...
  },
  {
    ...
    category: 'Body Composition',
    siteCategory: 'Health',
    shortDef: 'Sarcopenia is the age-related progressive loss of skeletal muscle mass, strength, and physical performance. It typically begins around age 40 at roughly 3-8% per decade and accelerates after 65. Because muscle can be replaced by fat without changing body weight, sarcopenia can be invisible to BMI - making grip strength and functional tests essential companions to weight-based measures.',
    relatedTools: ['/health/bmi-calculator/seniors', '/health/bmi-calculator', '/health/lean-body-mass-calculator', '/health/ffmi-calculator'],
    relatedTerms: ['bmi', 'body-composition', 'lean-body-mass', 'geriatric-bmi', 'body-fat-percentage'],
  },
  {
    slug: 'merit-increase',
    term: 'Merit Increase',
  ...
  },
  {
    ...
    relatedTools: ['/health/bmi-calculator/women', '/health/body-fat-calculator', '/health/lean-body-mass-calculator', '/health/bmi-calculator/menopause', '/health/bmi-calculator/seniors'],
